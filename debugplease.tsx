...
export const MultiChainPresale: FC = () => {
  ...
  console.log("000000000 totalTokensSold", totalTokensSold)
  console.log("777777777777 stageData?.availableTokens", stageData?.availableTokens)
  console.log("****&&&&^^^%%% ", Math.min(
    (totalTokensSold / (stageData?.availableTokens || 1)) * 100,
    100
  ))
